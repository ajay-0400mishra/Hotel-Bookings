...
# --------- Clustering Tab ---------
    ...
    # Simple numeric encoding for clustering
    df_enc = pd.get_dummies(df.select_dtypes(include="object"))
    k_default = 4
...
# --------- Association Rules Tab ---------
    ...
    if col_choice:
        ...
        basket = df[col_choice].apply(lambda row: ", ".join(row.dropna()), axis=1)
        # Binary encoding
        unique_items = set()
        for items in basket:
...
# --------- Regression Tab ---------
    ...
    # Map ADR Budget to numeric midpoints
    budget_map = {
        "<2000": 1500,
        "2000–4000": 3000,
        "4000–7000": 5500,
